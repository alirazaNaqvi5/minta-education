    ...
    return (
        <React.Fragment>
            <div id="navbar" className="navbar-area">
                <div className="minta-nav admin-nav">
                                        ...
                                        {user ? (
                                            <div className="user-dropdown">
                                                ...
                                                <ul className="dropdown-menu">
                                                    ...
                                                    <li className="nav-item">
                                                        <Link href="/my-courses/certs" activeClassName="active">
                                                            <a onClick={toggleNavbar} className="nav-link">My Certificates</a>
                                                        </Link>
                                                    </li> 
                            ...
                            <div className="td-sidebar">
                                <ul>
                                    <li>
                                        ...
                                        <Link href="/admin/pending-courses" activeClassName="active">
                                            <a>Pending Courses</a>
                                        </Link>
                                        <Link href="/admin/course-categories" activeClassName="active">
