                    ...
                    <div className="row">
                        <div className="col-lg-8 col-md-12">
                            <div className="purchase-guide-content">
                                ...
                                <h3>1. Our website</h3>
                                <p>Our website address is: http://minta.uk</p>
                                ...
                                <blockquote className="blockquote">
                                    <p>We collect certain data from you directly, like information you enter yourself, data about your participation in courses, and data from third-party platforms you connect with minta. We also collect some data automatically, like information about your device and what parts of our Services you interact with or spend time using.</p>
                                </blockquote>
